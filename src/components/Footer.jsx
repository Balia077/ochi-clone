...
const Footer = () => {
    return (
        <div className='w-full flex gap-5 h-screen bg-zinc-900 py-20 px-14'>
            <div className='w-1/2 h-full flex flex-col justify-between font-[font-1]'>
                <div className='heading'>
                    <h1 className='text-[9vw] uppercase leading-25'>Eye-</h1>
                    <h1 className='text-[9vw] uppercase leading-25'>Opening</h1>
                </div>
            ...
            <div className='w-1/2'>
                <h1 className='text-[9vw] uppercase leading-25 font-[font-1]'>presentations</h1>
                <div className='details font-[font-2] mt-5'>
                    <h1 className='py-5'>S:</h1>
                    <a className='block text-lg' href="#">Instagram</a>
                    <a className='block text-lg' href="#">Facebook</a>
                    <a className='block text-lg' href="#">Twitter</a>
                    <a className='block text-lg' href="#">LinkedIn</a>
                </div>
                 <div className='details font-[font-2] mt-5'>
                    <h1 className='py-5'>L:</h1>
                    <a className='block text-lg' href="#">202-1965 W 4th Ave</a>
                    <a className='block text-lg' href="#">Vancouver, Canada</a>
                    <a className='block text-lg' href="#">30 Chukarina St</a>
                    <a className='block text-lg' href="#">Lviv, Ukraine</a>
                </div>
            </div>
        </div>
    )
